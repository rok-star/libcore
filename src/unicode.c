...
void __utf8_to_utf16(char const* utf8_string, int utf8_length, int* utf8_read, uint16_t* utf16_string, int utf16_capacity, int* utf16_write) {
	_ASSERT(utf8_string != NULL);
...
void __utf8_to_utf32(char const* utf8_string, int utf8_length, int* utf8_read, uint32_t* utf32_string, int utf32_capacity, int* utf32_write) {
	_ASSERT(utf8_string != NULL);
	_ASSERT(utf8_read != NULL);
...
void __utf16_to_utf8(uint16_t const* utf16_string, int utf16_length, int* utf16_read, char* utf8_string, int utf8_capacity, int* utf8_write) {
	_ASSERT(utf16_string != NULL);
...
void __utf16_to_utf32(uint16_t const* utf16_string, int utf16_length, int* utf16_read, uint32_t* utf32_string, int utf32_capacity, int* utf32_write) {
	_ASSERT(utf16_string != NULL);
	_ASSERT(utf16_read != NULL);
	_ASSERT(utf32_string != NULL);
	_ASSERT(utf32_write != NULL);
...
void __utf32_to_utf8(uint32_t const* utf32_string, int utf32_length, int* utf32_read, char* utf8_string, int utf8_capacity, int* utf8_write) {
	_ASSERT(utf32_string != NULL);
...
void __utf32_to_utf16(uint32_t const* utf32_string, int utf32_length, int* utf32_read, uint16_t* utf16_string, int utf16_capacity, int* utf16_write) {
	_ASSERT(utf32_string != NULL);
	_ASSERT(utf32_read != NULL);
	_ASSERT(utf16_string != NULL);
	_ASSERT(utf16_write != NULL);
