...
void _value_array_set(_value_t*,int64_t,_value_t*);
void _value_array_push(_value_t*,_value_t*);
void _value_array_unshift(_value_t*,_value_t*);
...
void _value_map_set(_value_t*,char const*,int64_t,_value_t*);
